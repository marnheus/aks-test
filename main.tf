...
# VPN client profile - downloaded from gateway and modified with DNS
# The actual profile is generated by 'az network vnet-gateway vpn-client generate'
# and stored with DNS resolver IP injected into clientconfig
resource "terraform_data" "vpn_profile_generator" {
  triggers_replace = [
